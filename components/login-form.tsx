...
export function LoginForm({
  ...
  useEffect(() => {
    if (status === "authenticated") {
      ...
      else if (role === "super") router.replace("/super");
      else if (role === "waiter") router.replace("/admin");
      else if (role === "kitchen") router.replace("/admin/kitchen");
      else router.replace("/");
    }
  ...
  const onSubmit = async (data: LoginFormInputs) => {
    ...
    if (result?.error) {
      ...
      else if (role === "super") router.push("/super");
      else if (role === "waiter") router.push("/admin");
